 ...
 * Verifies byte-identical assembly against extraction templates.
 */
...
describe('SC-001: Photo mode golden files', () => {
  ...
  it('full state with all fragments produces ordered output', () => {
    ...
    // Verify fragment ordering per EXTRACTION.md §3:
  ...
  it('appends noText guard when noText is true (FR-006)', () => {
    ...
    // noText is handled in anime mode; photo mode doesn't use it per EXTRACTION.md §3
