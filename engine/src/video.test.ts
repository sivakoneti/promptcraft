/**
 * Video engine goldens.
 * Verifies camera movement catalog, autofill composition, and Director multi-shot mechanics.
 */
...
describe('SPC-003 FR-004: movement catalog', () => {
  ...
  it('label → promptKeyword table is complete and valid', () => {
...
describe('Autofill sentence composition', () => {
